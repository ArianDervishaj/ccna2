const quizData = [
  {
    "title": "1. Refer to the exhibit. What will router R1 do with a packet that has a destination IPv6 address of 2001:db8:cafe:5::1?",
    "text": "",
    "images": [
    ...
    "explanation": "The route ::/0 is the compressed form of the 0000:0000:0000:0000:0000:0000:0000:0000/0 default route. <br> The default route is used if a more specific route is not found in the routing table.",
    "id": 1
  },
  {
    "title": "2. Refer to the exhibit. Currently router R1 uses an EIGRP route learned from Branch2 to reach the 10.10.0.0/16 network. Which floating static route would create a backup route to the 10.10.0.0/16 network in the event that the link between R1 and Branch2 goes down?",
    "text": "",
    "images": [
  ...
  {
    "title": "3. Refer to the exhibit. R1 was configured with the static route command ip route 209.165.200.224 255.255.255.224 S0/0/0 and consequently users on network 172.16.0.0/16 are unable to reach resources on the Internet. How should this static route be changed to allow user traffic from the LAN to reach the Internet?",
    "text": "",
    "images": [
    ...
    "explanation": "Explain: The static route on R1 has been incorrectly configured with the wrong destination network and mask. The correct destination network and mask is 0.0.0.0 0.0.0.0.",
    "id": 3
  },
  {
    "title": "4. Which option shows a correctly configured IPv4 default static route?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "5. Refer to the exhibit. Which static route command can be entered on R1 to forward traffic to the LAN connected to R2?",
    "text": "",
    "images": [
  ...
  {
    "title": "7. A cybersecurity analyst is using the macof tool to evaluate configurations of switches deployed in the backbone network of an organization. Which type of LAN attack is the analyst targeting during this evaluation?",
    "text": "",
    "images": [],
    "options": [
      "VLAN hopping",
  ...
  {
    "title": "8. Refer to the exhibit. A network administrator is configuring a router as a DHCPv6 server. The administrator issues a show ipv6 dhcp pool command to verify the configuration. Which statement explains the reason that the number of active clients is 0?",
    "text": "",
    "images": [
  ...
  {
    "title": "11. Which statement is correct about how a Layer 2 switch determines how to forward frames?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "12. Which statement describes a result after multiple Cisco LAN switches are interconnected?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "14.Refer to the exhibit. How is a frame sent from PCA forwarded to PCC if the MAC address table on switch SW1 is empty?",
    "text": "",
    "images": [
  ...
  {
    "title": "15. An administrator is trying to remove configurations from a switch. After using the command erase startup-config and reloading the switch, the administrator finds that VLANs 10 and 100 still exist on the switch. Why were these VLANs not removed?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "17. Refer to the exhibit. A network administrator has connected two switches together using EtherChannel technology. If STP is running, what will be the end result?",
    "text": "",
    "images": [
  ...
  {
    "title": "18. What is a secure configuration option for remote access to a network device?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "19. Which wireless encryption method is the most secure?",
    "text": "",
    "images": [],
    "options": [
      "WPA2 with AES",
  ...
  {
    "title": "20. After attaching four PCs to the switch ports, configuring the SSID and setting authentication properties for a small office network, a technician successfully tests the connectivity of all PCs that are connected to the switch and WLAN. A firewall is then configured on the device prior to connecting it to the Internet. What type of network device includes all of the described features?",
    "text": "",
    "images": [],
    "options": [
      "firewall appliance",
  ...
  {
    "title": "21. Refer to the exhibit. Host A has sent a packet to host B. What will be the source MAC and IP addresses on the packet when it arrives at host B?",
    "text": "",
    "images": [
  ...
  {
    "title": "24. What protocol or technology disables redundant paths to eliminate Layer 2 loops?",
    "text": "",
    "images": [],
    "options": [
      "VTP",
  ...
  {
    "title": "25. Refer to the exhibit. Based on the exhibited configuration and output, why is VLAN 99 missing?",
    "text": "",
    "images": [
  ...
  {
    "title": "26. Which two VTP modes allow for the creation, modification, and deletion of VLANs on the local switch? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
      "client",
  ...
  {
    "title": "27. Which three steps should be taken before moving a Cisco switch to a new VTP management domain? (Choose three.)",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "28. A network administrator is preparing the implementation of Rapid PVST+ on a production network. How are the Rapid PVST+ link types determined on the switch interfaces?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "29. Refer to the exhibit. All the displayed switches are Cisco 2960 switches with the same default priority and operating at the same bandwidth. Which three ports will be STP designated ports? (Choose three.)",
    "text": "",
    "images": [
  ...
  {
    "title": "30. How will a router handle static routing differently if Cisco Express Forwarding is disabled?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "31. Compared with dynamic routes, what are two advantages of using static routes on a router? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "32. Refer to the exhibit. Which route was configured as a static route to a specific network using the next-hop address?",
    "text": "",
    "images": [
    ...
    "explanation": "The C in a routing table indicates an interface that is up and has an IP address assigned. <br>The S in a routing table signifies that a route was installed using the ip route command. <br>Two of the routing table entries shown are static routes to a specific destination (the 192.168.2.0 network). <br>The entry that has the S denoting a static route and [1/0] was configured using the next-hop address. <br>The other entry (S 192.168.2.0/24 is directly connected, Serial 0/0/0) is a static route configured using the exit interface. <br>The entry with the 0.0.0.0 route is a default static route which is used to send packets to any destination network that is not specifically listed in the routing table.",
    "id": 31
  },
  {
    "title": "33. What is the effect of entering the spanning-tree portfast configuration command on a switch?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "34. What is the IPv6 prefix that is used for link-local addresses?",
    "text": "",
    "images": [],
    "options": [
      "FF01::/8",
  ...
  {
    "title": "35. Which two statements are characteristics of routed ports on a multilayer switch? (Choose two.)​",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "37. Which command will start the process to bundle two physical interfaces to create an EtherChannel group via LACP?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "38. What action takes place when a frame entering a switch has a multicast destination MAC address?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "39. A junior technician was adding a route to a LAN router. A traceroute to a device on the new network revealed a wrong path and unreachable status. What should be done or checked?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "40. Select the three PAgP channel establishment modes. (Choose three.)",
    "text": "",
    "images": [],
    "options": [
      "auto",
  ...
  {
    "title": "41. A static route has been configured on a router. However, the destination network no longer exists. What should an administrator do to remove the static route from the routing table?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "42. Refer to the exhibit. What can be concluded about the configuration shown on R1?",
    "text": "",
    "images": [
  ...
  {
    "title": "44. Refer to the exhibit. R1 has been configured as shown. However, PC1 is not able to receive an IPv4 address. What is the problem?​",
    "text": "",
    "images": [
  ...
  {
    "title": "45. What two default wireless router settings can affect network security? (Choose two.)",
    "text": "",
    "images": [
  ...
  {
    "title": "47. A network administrator is adding a new WLAN on a Cisco 3500 series WLC. Which tab should the administrator use to create a new VLAN interface to be used for the new WLAN?",
    "text": "",
    "images": [],
    "options": [
      "WIRELESS",
  ...
  {
    "title": "48. A network administrator is configuring a WLAN. Why would the administrator change the default DHCP IPv4 addresses on an AP?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "49. Which two functions are performed by a WLC when using split media access control (MAC)? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "50. On what switch ports should BPDU guard be enabled to enhance STP stability?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "51. Which network attack is mitigated by enabling BPDU guard?",
    "text": "",
    "images": [],
    "options": [
  ...
  },
  {
    ...
    "explanation": "Explain: The problem with the current floating static route is that the administrative distance is set too low. The administrative distance will need to be higher than that of OSPF, which is 110, so that the router will only use the OSPF link when it is up.",
    "id": 51
  },
  {
    "title": "53. Refer to the exhibit. Router R1 has an OSPF neighbor relationship with the ISP router over the 192.168.0.32 network. The 192.168.0.36 network link should serve as a backup when the OSPF link goes down. The floating static route command ip route 0.0.0.0 0.0.0.0 S0/0/1 100 was issued on R1 and now traffic is using the backup link even when the OSPF link is up and functioning. Which change should be made to the static route command so that traffic will only use the OSPF link when it is up?​",
    "text": "",
    "images": [
  ...
  {
    "title": "54. Refer to the exhibit. What is the metric to forward a data packet with the IPv6 destination address 2001:DB8:ACAD:E:240:BFF:FED4:9DD2?",
    "text": "",
    "images": [
    ...
    "explanation": "Explain: The IPv6 destination address 2001:DB8:ACAD:E:240:BFF:FED4:9DD2 belongs to the network of 2001:DB8:ACAD:E::/64. In the routing table, the route to forward the packet has Serial 0/0/1 as an exit interface and 2682112 as the cost.",
    "id": 53
  },
  {
    "title": "55. A network administrator is configuring a new Cisco switch for remote management access. Which three items must be configured on the switch for the task? (Choose three.)",
    "text": "",
    "images": [],
    "options": [
      "IP address",
  ...
  },
  {
    ...
    "explanation": "Explain: The interface command ipv6 nd other-config-flag allows RA messages to be sent on this interface, indicating that additional information is available from a stateless DHCPv6 server.",
    "id": 55
  },
  {
    "title": "57. Refer to the exhibit. A Layer 3 switch routes for three VLANs and connects to a router for Internet connectivity. Which two configurations would be applied to the switch? (Choose two.)",
    "text": "",
    "images": [
  ...
  {
    "title": "58. A technician is troubleshooting a slow WLAN and decides to use the split-the-traffic approach. Which two parameters would have to be configured to do this? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "59. A company has just switched to a new ISP. The ISP has completed and checked the connection from its site to the company. However, employees at the company are not able to access the internet. What should be done or checked?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "60. Which information does a switch use to populate the MAC address table?",
    "text": "",
    "images": [],
    "options": [
    ...
    "explanation": "Explain: To maintain the MAC address table, the switch uses the source MAC address of the incoming packets and the port that the packets enter. The destination address is used to select the outgoing port.",
    "id": 59
  },
  {
    "title": "61. Refer to the exhibit. A network administrator is reviewing the configuration of switch S1. Which protocol has been implemented to group multiple physical ports into one logical link?",
    "text": "",
    "images": [
  ...
  {
    "title": "62. Which type of static route is configured with a greater administrative distance to provide a backup route to a route learned from a dynamic routing protocol?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "66. Refer to the exhibit. Which three hosts will receive ARP requests from host A, assuming that port Fa0/4 on both switches is configured to carry traffic for multiple VLANs? (Choose three.)",
    "text": "",
    "images": [
    ...
    "explanation": "Explain: ARP requests are sent out as broadcasts. That means the ARP request is sent only throughout a specific VLAN. VLAN 1 hosts will only hear ARP requests from hosts on VLAN 1. VLAN 2 hosts will only hear ARP requests from hosts on VLAN 2.",
    "id": 65
  },
  {
    "title": "67. Refer to the exhibit. The network administrator configures both switches as displayed. However, host C is unable to ping host D and host E is unable to ping host F. What action should the administrator take to enable this communication?",
    "text": "",
    "images": [
  ...
  {
    "title": "68. What is the effect of entering the shutdown configuration command on a switch?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "69. What would be the primary reason an attacker would launch a MAC address overflow attack?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "70. During the AAA process, when will authorization be implemented?",
    "text": "",
    "images": [],
    "options": [
    ...
    "explanation": "Explain: A. AAA authorization is implemented immediately after the user is authenticated against a specific AAA data source.",
    "id": 69
  },
  {
    "title": "71. A company security policy requires that all MAC addressing be dynamically learned and added to both the MAC address table and the running configuration on each switch. Which port security configuration will accomplish this?",
    "text": "",
    "images": [],
    "options": [
    ...
    "explanation": "Explain: With sticky secure MAC addressing, the MAC addresses can be either dynamically learned or manually configured and then stored in the address table and added to the running configuration file. In contrast, dynamic secure MAC addressing provides for dynamically learned MAC addressing that is stored only in the address table.",
    "id": 70
  },
  {
    "title": "72. Which three Wi-Fi standards operate in the 2.4GHz range of frequencies? (Choose three.)",
    "text": "",
    "images": [],
    "options": [
      "802.11a",
  ...
  {
    "title": "73. To obtain an overview of the spanning tree status of a switched network, a network engineer issues the show spanning-tree command on a switch. Which two items of information will this command display? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
      "The root bridge BID.",
  ...
  {
    "title": "74. Refer to the exhibit. Which trunk link will not forward any traffic after the root bridge election process is complete?",
    "text": "",
    "images": [
  ...
  {
    "title": "75. Which method of IPv6 prefix assignment relies on the prefix contained in RA messages?",
    "text": "",
    "images": [],
    "options": [
      "EUI-64",
  ...
  {
    "title": "76. Which two protocols are used to provide server-based AAA authentication? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
      "802.1x",
  ...
  {
    "title": "77. A network administrator is configuring a WLAN. Why would the administrator disable the broadcast feature for the SSID?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "78. Which mitigation technique would prevent rogue servers from providing false IP configuration parameters to clients?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "79. A network administrator configures the port security feature on a switch. The security policy specifies that each access port should allow up to two MAC addresses. When the maximum number of MAC addresses is reached, a frame with the unknown source MAC address is dropped and a notification is sent to the syslog server. Which security violation mode should be configured for each access port?",
    "text": "",
    "images": [],
    "options": [
      "shutdown",
    ...
    "explanation": "In port security implementation, an interface can be configured for one of three violation modes: <br>Protect – a port security violation causes the interface to drop packets with unknown source addresses and no notification is sent that a security violation has occurred. <br>Restrict – a port security violation causes the interface to drop packets with unknown source addresses and to send a notification that a security violation has occurred. <br>Shutdown – a port security violation causes the interface to immediately become error-disabled and turns off the port LED. No notification is sent that a security violation has occurred.",
    "id": 78
  },
  {
    "title": "80. What protocol or technology defines a group of routers, one of them defined as active and another one as standby?",
    "text": "",
    "images": [],
    "options": [
      "EtherChannel",
  ...
  {
    "title": "81. Refer to the exhibit. After attempting to enter the configuration that is shown in router RTA, an administrator receives an error and users on VLAN 20 report that they are unable to reach users on VLAN 30. What is causing the problem?",
    "text": "",
    "images": [
  ...
  {
    "title": "82. Which three pairs of trunking modes will establish a functional trunk link between two Cisco switches? (Choose three.)",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "83. A technician is configuring a router for a small company with multiple WLANs and doesn’t need the complexity of a dynamic routing protocol. What should be done or checked?",
    "text": "",
    "images": [],
    "options": [
      "Verify that there is not a default route in any of the edge router routing tables.",
  ...
  {
    "title": "84. A company is deploying a wireless network in the distribution facility in a Boston suburb. The warehouse is quite large and it requires multiple access points to be used. Because some of the company devices still operate at 2.4GHz, the network administrator decides to deploy the 802.11g standard. Which channel assignments on the multiple access points will make sure that the wireless channels are not overlapping?",
    "text": "",
    "images": [],
    "options": [
      "channels 1, 5, and 9",
  ...
  {
    "title": "85. A network administrator of a small advertising company is configuring WLAN security by using the WPA2 PSK method. Which credential do office users need in order to connect their laptops to the WLAN?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "86. Refer to the exhibit. What are the possible port roles for ports A, B, C, and D in this RSTP-enabled network?",
    "text": "",
    "images": [
  ...
  {
    "title": "87. Refer to the exhibit. Which static route would an IT technician enter to create a backup route to the 172.16.1.0 network that is only used if the primary RIP learned route fails?",
    "text": "",
    "images": [
  ...
  {
    "title": "88. What mitigation plan is best for thwarting a DoS attack that is creating a MAC address table overflow?",
    "text": "",
    "images": [],
    "options": [
      "Disable DTP.",
  ...
  {
    "title": "89. A network engineer is troubleshooting a newly deployed wireless network that is using the latest 802.11 standards. When users access high bandwidth services such as streaming video, the wireless network performance is poor. To improve performance the network engineer decides to configure a 5 Ghz frequency band SSID and train users to use that SSID for streaming media services. Why might this solution improve the wireless network performance for that type of service?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "90. Which DHCPv4 message will a client send to accept an IPv4 address that is offered by a DHCP server?",
    "text": "",
    "images": [],
    "options": [
      "broadcast DHCPACK",
  ...
  {
    "title": "91. Refer to the exhibit. Which destination MAC address is used when frames are sent from the workstation to the default gateway?",
    "text": "",
    "images": [
  ...
  {
    "title": "92. After a host has generated an IPv6 address by using the DHCPv6 or SLAAC process, how does the host verify that the address is unique and therefore usable?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "94. Which protocol adds security to remote connections?",
    "text": "",
    "images": [],
    "options": [
      "FTP",
  ...
  {
    "title": "95. Refer to the exhibit. A network administrator is verifying the configuration of inter-VLAN routing. Users complain that PC2 cannot communicate with PC1. Based on the output, what is the possible cause of the problem?",
    "text": "",
    "images": [
  ...
  {
    "title": "96. Refer to the exhibit. A network administrator is configuring inter-VLAN routing on a network. For now, only one VLAN is being used, but more will be added soon. What is the missing parameter that is shown as the highlighted question mark in the graphic?",
    "text": "",
    "images": [
  ...
  {
    "title": "98. What network attack seeks to create a DoS for clients by preventing them from being able to obtain a DHCP lease?",
    "text": "",
    "images": [],
    "options": [
      "IP address spoofing",
  ...
  {
    "title": "99. Refer to the exhibit. If the IP addresses of the default gateway router and the DNS server are correct, what is the configuration problem?",
    "text": "",
    "images": [
  ...
  {
    "title": "100. Refer to the exhibit. A network administrator has added a new subnet to the network and needs hosts on that subnet to receive IPv4 addresses from the DHCPv4 server. What two commands will allow hosts on the new subnet to receive addresses from the DHCP4 server? (Choose two.)",
    "text": "",
    "images": [
  ...
  {
    "title": "101. What protocol or technology uses source IP to destination IP as a load-balancing mechanism?",
    "text": "",
    "images": [],
    "options": [
      "VTP",
  ...
  {
    "title": "102. What protocol should be disabled to help mitigate VLAN attacks?",
    "text": "",
    "images": [],
    "options": [
      "CDP",
  ...
  {
    "title": "103. What protocol or technology requires switches to be in server mode or client mode?",
    "text": "",
    "images": [],
    "options": [
      "EtherChannel",
  ...
  {
    "title": "104. What are two reasons a network administrator would segment a network with a Layer 2 switch? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "105. What command will enable a router to begin sending messages that allow it to configure a link-local address without using an IPv6 DHCP server?",
    "text": "",
    "images": [],
    "options": [
      "a static route",
  ...
  {
    "title": "106. A network administrator is using the router-on-a-stick model to configure a switch and a router for inter-VLAN routing. What configuration should be made on the switch port that connects to the router?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "107. What are three techniques for mitigating VLAN attacks? (Choose three.)",
    "text": "",
    "images": [],
    "options": [
      "Use private VLANs.",
  ...
  },
  {
    ...
    "explanation": "The DHCPv4 process follows the DORA sequence: <br>1) DHCPDISCOVER - client broadcasts to find servers, <br>2) DHCPOFFER - server offers an IP, <br>3) DHCPREQUEST - client requests the offered IP, <br>4) DHCPACK - server acknowledges and finalizes the lease.",
    "id": 107
  },
  {
    "title": "109. In which situation would a technician use the show interfaces switch command?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "110. What is a drawback of the local database method of securing device access that can be solved by using AAA with centralized servers?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "111. What action does a DHCPv4 client take if it receives more than one DHCPOFFER from multiple DHCP servers?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "112. Refer to the exhibit. The network administrator is configuring the port security feature on switch SWC. The administrator issued the command show port-security interface fa 0/2 to verify the configuration. What can be concluded from the output that is shown? (Choose three.)",
    "text": "",
    "images": [
  ...
  {
    "title": "113. What method of wireless authentication is dependent on a RADIUS authentication server?",
    "text": "",
    "images": [],
    "options": [
      "WEP",
  ...
  {
    "title": "114. A network administrator has found a user sending a double-tagged 802.1Q frame to a switch. What is the best solution to prevent this type of attack?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "115. Refer to the exhibit. Which two conclusions can be drawn from the output? (Choose two.)",
    "text": "",
    "images": [
  ...
  },
  {
    ...
    "explanation": "HSRP failover: <br>1) The active/forwarding router fails, <br>2) The standby router detects the failure by missing hello messages, <br>3) The standby assumes the forwarding role with the virtual IP and MAC, so hosts don't need to update their ARP cache.",
    "id": 115
  },
  {
    "title": "117. On a Cisco 3504 WLC Summary page ( Advanced > Summary ), which tab allows a network administrator to configure a particular WLAN with a WPA2 policy?",
    "text": "",
    "images": [],
    "options": [
      "WLANs",
  ...
  {
    "title": "118. Refer to the exhibit. A network engineer is configuring IPv6 routing on the network. Which command issued on router HQ will configure a default route to the Internet to forward packets to an IPv6 destination network that is not listed in the routing table?​",
    "text": "",
    "images": [
  ...
  {
    "title": "119. Users are complaining of sporadic access to the internet every afternoon. What should be done or checked?",
    "text": "",
    "images": [],
    "options": [
      "Create static routes to all internal networks and a default route to the internet.",
  ...
  {
    "title": "120. What action takes place when the source MAC address of a frame entering a switch appears in the MAC address table associated with a different port?",
    "text": "",
    "images": [],
    "options": [
      "The switch purges the entire MAC address table.",
  ...
  {
    "title": "121. A network administrator is configuring a WLAN. Why would the administrator use a WLAN controller?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "122. A new Layer 3 switch is connected to a router and is being configured for interVLAN routing. What are three of the five steps required for the configuration? (Choose three.)",
    "text": "Case 7 (NEW):",
    "images": [],
    "options": [
  ...
  {
    "title": "123. Which three statements accurately describe duplex and speed settings on Cisco 2960 switches? (Choose three.)",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "124. Refer to the exhibit. A network administrator configures R1 for inter-VLAN routing between VLAN 10 and VLAN 20. However, the devices in VLAN 10 and VLAN 20 cannot communicate. Based on the configuration in the exhibit, what is a possible cause for the problem?",
    "text": "",
    "images": [
  ...
  {
    "title": "125. A network administrator uses the spanning-tree portfast bpduguard default global configuration command to enable BPDU guard on a switch. However, BPDU guard is not activated on all access ports. What is the cause of the issue?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "126. Which two types of spanning tree protocols can cause suboptimal traffic flows because they assume only one spanning-tree instance for the entire bridged network? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
      "MSTP",
  ...
  {
    "title": "127. Refer to the exhibit. A network administrator is configuring the router R1 for IPv6 address assignment. Based on the partial configuration, which IPv6 global unicast address assignment scheme does the administrator intend to implement?",
    "text": "",
    "images": [
  ...
  {
    "title": "128. A WLAN engineer deploys a WLC and five wireless APs using the CAPWAP protocol with the DTLS feature to secure the control plane of the network devices. While testing the wireless network, the WLAN engineer notices that data traffic is being exchanged between the WLC and the APs in plain-text and is not being encrypted. What is the most likely reason for this?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "129. A new switch is to be added to an existing network in a remote office. The network administrator does not want the technicians in the remote office to be able to add new VLANs to the switch, but the switch should receive VLAN updates from the VTP domain. Which two steps must be performed to configure VTP on the new switch to meet these conditions? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "130. Refer to the exhibit. Consider that the main power has just been restored. PC3 issues a broadcast IPv4 DHCP request. To which port will SW1 forward this request?​",
    "text": "",
    "images": [
  ...
  {
    "title": "131. What action takes place when the source MAC address of a frame entering a switch is not in the MAC address table?",
    "text": "Case 1",
    "images": [],
    "options": [
      "The switch forwards the frame out of the specified port.",
  ...
  {
    "title": "132. Employees are unable to connect to servers on one of the internal networks. What should be done or checked?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "133. What is the effect of entering the ip dhcp snooping configuration command on a switch?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "134. An administrator notices that large numbers of packets are being dropped on one of the branch routers. What should be done or checked?",
    "text": "",
    "images": [],
    "options": [
      "Create static routes to all internal networks and a default route to the internet.",
  ...
  {
    "title": "135. What are two switch characteristics that could help alleviate network congestion? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "136. What is a result of connecting two or more switches together?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "138. Branch users were able to access a site in the morning but have had no connectivity with the site since lunch time. What should be done or checked?",
    "text": "",
    "images": [],
    "options": [
      "Verify that the static route to the server is present in the routing table.",
  ...
  {
    "title": "139. What is the effect of entering the switchport port-security configuration command on a switch?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "140. A network administrator is configuring a WLAN. Why would the administrator use multiple lightweight APs?",
    "text": "",
    "images": [],
    "options": [
      "to centralize management of multiple WLANs",
  ...
  {
    "title": "141. Refer to the exhibit. PC-A and PC-B are both in VLAN 60. PC-A is unable to communicate with PC-B. What is the problem?",
    "text": "",
    "images": [
  ...
  {
    "title": "142. A network administrator is configuring a WLAN. Why would the administrator use RADIUS servers on the network?",
    "text": "",
    "images": [],
    "options": [
      "to centralize management of multiple WLANs",
  ...
  {
    "title": "143. What is the effect of entering the switchport mode access configuration command on a switch?",
    "text": "",
    "images": [],
    "options": [
      "It enables BPDU guard on a specific port.",
  ...
  {
    "title": "144. A network administrator has configured a router for stateless DHCPv6 operation. However, users report that workstations are not receiving DNS server information. Which two router configuration lines should be verified to ensure that stateless DHCPv6 service is properly configured? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "145. A network administrator is configuring a WLAN. Why would the administrator disable the broadcast feature for the SSID?",
    "text": "",
    "images": [],
    "options": [
      "to eliminate outsiders scanning for available SSIDs in the area",
  ...
  {
    "title": "146. Refer to the exhibit. An administrator is attempting to install an IPv6 static route on router R1 to reach the network attached to router R2. After the static route command is entered, connectivity to the network is still failing. What error has been made in the static route configuration?",
    "text": "",
    "images": [
  ...
  {
    "title": "147. What action takes place when a frame entering a switch has a unicast destination MAC address that is not in the MAC address table?",
    "text": "",
    "images": [],
    "options": [
      "The switch updates the refresh timer for the entry.",
  ...
  {
    "title": "148. A junior technician was adding a route to a LAN router. A traceroute to a device on the new network revealed a wrong path and unreachable status. What should be done or checked?",
    "text": "",
    "images": [],
    "options": [
      "Create a floating static route to that network.",
  ...
  {
    "title": "149. What is the effect of entering the ip arp inspection vlan 10 configuration command on a switch?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "150. What protocol or technology manages trunk negotiations between switches?",
    "text": "",
    "images": [],
    "options": [
      "VTP",
  ...
  {
    "title": "151. A network administrator is configuring a WLAN. Why would the administrator apply WPA2 with AES to the WLAN?",
    "text": "",
    "images": [],
    "options": [
      "to reduce the risk of unauthorized APs being added to the network",
  ...
  {
    "title": "152. Users on a LAN are unable to get to a company web server but are able to get elsewhere. What should be done or checked?",
    "text": "",
    "images": [],
    "options": [
      "Ensure that the old default route has been removed from the company edge routers.",
  ...
  {
    "title": "153. What IPv6 prefix is designed for link-local communication?",
    "text": "",
    "images": [],
    "options": [
      "2001::/3",
  ...
  {
    "title": "155. A network administrator is configuring a WLAN. Why would the administrator change the default DHCP IPv4 addresses on an AP?",
    "text": "",
    "images": [],
    "options": [
      "to eliminate outsiders scanning for available SSIDs in the area",
  ...
  {
    "title": "156. What is the effect of entering the ip arp inspection validate src-mac configuration command on a switch?",
    "text": "",
    "images": [],
    "options": [
      "It checks the source L2 address in the Ethernet header against the sender L2 address in the ARP body.",
  ...
  {
    "title": "157. What protocol or technology is a Cisco proprietary protocol that is automatically enabled on 2960 switches?",
    "text": "",
    "images": [],
    "options": [
      "DTP",
  ...
  {
    "title": "158. What address and prefix length is used when configuring an IPv6 default static route?",
    "text": "",
    "images": [],
    "options": [
      "::/0",
  ...
  {
    "title": "159. What are two characteristics of Cisco Express Forwarding (CEF)? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "160. Which term describes the role of a Cisco switch in the 802.1X port-based access control?",
    "text": "",
    "images": [],
    "options": [
      "agent",
  ...
  {
    "title": "161. Which Cisco solution helps prevent ARP spoofing and ARP poisoning attacks?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "163. What protocol or technology uses a standby router to assume packet-forwarding responsibility if the active router fails?",
    "text": "",
    "images": [],
    "options": [
      "EtherChannel",
  ...
  {
    "title": "164. What is the effect of entering the show ip dhcp snooping binding configuration command on a switch?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "165. What action takes place when the source MAC address of a frame entering a switch is in the MAC address table?",
    "text": "",
    "images": [],
    "options": [
      "The switch forwards the frame out of the specified port.",
  ...
  {
    "title": "166. A small publishing company has a network design such that when a broadcast is sent on the LAN, 200 devices receive the transmitted broadcast. How can the network administrator reduce the number of devices that receive broadcast traffic?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "168. What else is required when configuring an IPv6 static route using a next-hop link-local address?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "169. A technician is configuring a wireless network for a small business using a SOHO wireless router. Which two authentication methods are used, if the router is configured with WPA2? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
      "personal",
  ...
  {
    "title": "170. Which mitigation technique would prevent rogue servers from providing false IPv6 configuration parameters to clients?",
    "text": "",
    "images": [],
    "options": [
  ...
  {
    "title": "171. A PC has sent an RS message to an IPv6 router attached to the same network. Which two pieces of information will the router send to the client? (Choose two.)",
    "text": "",
    "images": [],
    "options": [
      "prefix length",
  ...
  {
    "title": "172. While attending a conference, participants are using laptops for network connectivity. When a guest speaker attempts to connect to the network, the laptop fails to display any available wireless networks. The access point must be operating in which mode?",
    "text": "",
    "images": [],
    "options": [
      "mixed",
  ...
  {
    "title": "173. Which three components are combined to form a bridge ID?",
    "text": "",
    "images": [],
    "options": [
      "extended system ID",
  ...
  {
    "title": "174. On a Cisco 3504 WLC Summary page (Advanced > Summary), which tab allows a network administrator to configure a particular WLAN with a WPA2 policy?",
    "text": "",
    "images": [],
    "options": [
      "SECURITY",
